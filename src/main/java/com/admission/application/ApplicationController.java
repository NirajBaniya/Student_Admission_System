...
public class ApplicationController {
	...
	public String submitApplication(ApplicationForm form, HttpServletRequest request, Model model) {
		...
		try {
			...
			// Check if user already applied to this specific course at this college
			if (applicationRepository.existsByUserAndCollegeAndCourse(user, college, form.getCourse())) {
				model.addAttribute("error",
						"You have already submitted an application for " + form.getCourse() + " at this college.");
				model.addAttribute("user", user);
